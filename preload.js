...
preload.prototype = {
	preload: function(){
        ...
        this.game.load.image("instruction", "assets/game_instructions.png");
        ...
        this.game.load.spritesheet("button", "assets/play_again.png");
        this.game.load.image("play", "assets/botton_start.png");
        this.game.load.image("pause", "assets/pause.png");       
        this.game.load.image("share", "assets/share.png");
        this.game.load.spritesheet('gamepad', 'assets/gamepad_spritesheet.png', 100, 100);
